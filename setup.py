#!/usr/bin/python3
import pandas as pd
from d_utils import config as c, runner_utils as ru, eval_utils as eu
...
def load_files(mapper: Mapper):
    ...
    disease_att_mapping = dm.get_disease_to_attributes(disease_set=disease_mapping.mondo, id_type="mondo", mapper=mapper)
