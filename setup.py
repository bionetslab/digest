...
def load_files(mapper: Mapper, scratch: bool = False):
    """
...
def main(scratch: bool = False):
    os.system("mkdir -p " + c.FILES_DIR + "tmp/")
    load_files(mapper=FileMapper(files_dir=os.path.join(c.FILES_DIR, "tmp", "")), scratch=scratch)
